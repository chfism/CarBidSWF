package fl.controls
{
   ...
   public class ScrollBar extends UIComponent
   {
      ...
      protected var Ҭ:BaseButton;
      
      protected var ҭ:BaseButton;
      
      protected var Ү:LabelButton;
      
      protected var ү:BaseButton;
      ...
      {
         return this.direction == ScrollBarDirection.HORIZONTAL?Number(super.height):Number(super.width);
      }
      
      override public function get height() : Number
      {
         return this.direction == ScrollBarDirection.HORIZONTAL?Number(super.width):Number(super.height);
      }
      ...
      public function set direction(param1:String) : void
      {
         ...
         ъ(1);
         var _loc2_:* = this.direction == ScrollBarDirection.HORIZONTAL;
      ...
      {
         super.configUI();
         this.ү = new BaseButton();
         this.ү.move(0,14);
         this.ү.useHandCursor = false;
         this.ү.ѭ = true;
         this.ү.focusEnabled = false;
         addChild(this.ү);
         this.Ү = new LabelButton();
         this.Ү.label = "";
         this.Ү.setSize(һ,15);
         this.Ү.move(0,15);
         this.Ү.focusEnabled = false;
         addChild(this.Ү);
         this.ҭ = new BaseButton();
         this.ҭ.setSize(һ,14);
         this.ҭ.ѭ = true;
      ...
      protected function Ҷ(param1:MouseEvent) : void
      {
         ...
         mouseChildren = false;
         var _loc2_:DisplayObjectBidInitView = я.form;

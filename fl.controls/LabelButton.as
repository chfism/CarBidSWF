package fl.controls
{
   ...
   public class LabelButton extends BaseButton implements IFocusManagerComponent
   {
      ...
      override protected function Ѵ() : void
      {
         ...
         var _loc2_:String = this.icon == null && this.Ѻ == "center"?ButtonLabelPlacement.TOP:this.Ѷ;
         ...
         else if(_loc2_ == ButtonLabelPlacement.BOTTOM || _loc2_ == ButtonLabelPlacement.TOP)
         {
            ...
            this.ѵ.y = Math.round((height - this.ѵ.height - _loc6_) / 2 + (_loc2_ == ButtonLabelPlacement.BOTTOM?_loc6_:0));
            if(this.icon != null)
            {
               this.icon.y = Math.round(_loc2_ == ButtonLabelPlacement.BOTTOM?Number(this.ѵ.y - _loc6_):Number(this.ѵ.y + this.ѵ.height + _loc1_));
            }
         }
         else
         {
            ...
            this.ѵ.width = _loc3_ = _loc7_;
            this.ѵ.x = Math.round((width - _loc3_ - _loc5_) / 2 + (_loc2_ != ButtonLabelPlacement.LEFT?_loc5_:0));
            this.ѵ.y = Math.round((height - this.ѵ.height) / 2);
            if(this.icon != null)
            {
               this.icon.x = Math.round(_loc2_ != ButtonLabelPlacement.LEFT?Number(this.ѵ.x - _loc5_):Number(this.ѵ.x + _loc3_ + _loc1_));
            }
         }
         super.Ѵ();
      }
